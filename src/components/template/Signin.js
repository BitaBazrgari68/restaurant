    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex py-4 px-24" dir="rtl">
            ...
            <div className="flex-1 flex">
                {/* کارت فرم */}
                <div className="bg-white/90 rounded-br-2xl rounded-tr-2xl backdrop-blur-sm shadow-[0_4px_6px_-1px_rgba(0,0,0,0.25)] p-8 relative overflow-hidden flex-1 flex flex-col justify-center">
                ...
                {/* قسمت راست - اطلاعات شرکت */}
                <div className='flex flex-col justify-center items-center flex-1 bg-primary rounded-tl-2xl rounded-bl-2xl backdrop-blur-sm shadow-[0_4px_6px_-1px_rgba(0,0,0,0.25)] py-8'>
