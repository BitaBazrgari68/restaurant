...
const Start = () => {
    return (
        <div>
            <section className="pt-20 pb-14 bg-white rounded-tr-[15vw] overflow-hidden z-10 shadow-[inset_0px_25px_50px_-25px_rgba(0,52,119,0.27)] ">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                        <Link href="https://www.instagram.com/data_trada" target="_blank" className="bg-primary text-secondary px-8 py-4 rounded-2xl  text-xl hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 relative before:absolute before:inset-1 before:rounded-2xl before:border-dashed before:border-1 before:border-[#FFAC30]/30 before:pointer-events-none">
